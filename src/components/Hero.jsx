...
const Hero = () => (
    <section className={`flex flex-col sm:flex-row ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl-px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row items-center justify-between w-full'>
          <h1 className='flex-1 font-semibold font-poppins ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]'>The Next <br className='hidden sm:block' /> {" "}
        ...
        <h1 className='flex-1 font-semibold font-poppins ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full'>
          Payment Method.
        </h1>
